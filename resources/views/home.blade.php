    ...
    <div class="container bg-light p-5" style="border-radius: 20px;">
        <div class="row my-5">
            <div class="col-md-6 d-flex align-items-center">
                <div>
                    <h2>Selamat Datang di Palugada.Store <br><b>PALUGADA.STRORE</b></h2>
                    <p class="text-secondary">Selling to you authentic unworn sneakers with a slight defect, <br>REQUEST YOUR OWN DREAM SHOES!</p>
